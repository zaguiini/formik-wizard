...
Also, React Native doesn't have submit button. To simulate, grab [**formik**'s context](how-do-you-access-the-formik-context-inside-the-step-form-eg-for-conditional-rendering) and fire its submit handler.
